...
$inicio = $data['reserva']['data_inicio'];
$fim = $data['reserva']['data_fim'];
$sala = $data['reserva']['sala'];
$id = $_GET['id'];
?>
            ...
            <div class="card p-4">
                ...
                <div class="row justify-content-center">
                    <div class="col-10">
                        ...
                        <form action="?ct=main&mt=reserva_edit_submit&id=<?=$id?>" method="post" class="col-12">
                            <div class="row justify-content-center">
                                <div class="col-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="datetime-local" name="text_inicio" id="text_inicio" class="form-control" value="<?=$inicio?>">
                                    ...
                                    <div class="col-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="datetime-local" name="text_fim" id="text_fim" class="form-control" value="<?=$fim?>">
                                        </div>
                                    </div>
